...
do_install() {
    ...
    install -d ${datadir}/qcom/sa8775p/Qualcomm/IQ9075-EVK/dsp/cdsp
    install -d ${datadir}/qcom/sa8775p/Qualcomm/SA8775P-RIDE/dsp/cdsp
    install -d ${datadir}/qcom/qcm6490/Thundercomm/RB3gen2/dsp/cdsp
...
PACKAGES += "\
    ${PN}-qcom-iq9075-evk-dsp \
    ${PN}-qcom-iq8275-evk-dsp \
    ${PN}-qcom-qcs8300-ride-dsp \
    ${PN}-qcom-sa8775p-ride-dsp \
    ${PN}-qcom-thundercomm-rb3gen2-cdsp \
"
...
FILES:${PN}-iq9075-evk-dsp += "${datadir}/qcom/sa8775p/Qualcomm/IQ9075-EVK/dsp/cdsp/*"
FILES:${PN}-iq8275-evk-dsp += "${datadir}/qcom/qcs8300/Qualcomm/IQ8275-EVK/dsp/cdsp/*"
FILES:${PN}-qcs8300-ride-dsp += "${datadir}/qcom/qcs8300/Qualcomm/QCS8300-RIDE/dsp/cdsp/*"
FILES:${PN}-sa8775p-ride-dsp += "${datadir}/qcom/sa8775p/Qualcomm/SA8775P-RIDE/dsp/cdsp/*"
